...
func checksum1( table: [[Int]] ) -> Int {
    return table.reduce( 0, { $0 + $1.max()! - $1.min()! } )
}

func checksum2( table: [[Int]] ) -> Int {
    var sum = 0
...
print( "Test1:", checksum1( table: parse( input: test1 ) ) )
print( "Test2:", checksum2( table: parse( input: test2 ) ) )

print( "Part1:", checksum1( table: parse( input: input ) ) )
print( "Part2:", checksum2( table: parse( input: input ) ) )
